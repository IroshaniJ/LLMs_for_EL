...
def main():
    ...
    for iter in range(3):
        ...
        for group_name, group_df in grouped:
            ...
            #prompt0 = f"Given the table title \"{TABLE_TITLE}\", summary \"{TABLE_SUMMARY}\", row \"{TABLE_ROW}\", along with referent entity candidates {REFERENT_ENTITY_CANDIDATES} and wikidata {WIKI_OUTPUT}, what is the correct entity for {X}"
            ...
            results.to_csv(f"../../../../projects/nn10072k/EMD/data/Dataset/{dataset}/{dataset}_RAG_results_{iter}.csv", index=False)
